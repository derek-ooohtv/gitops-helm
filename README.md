...
[![Build Status](https://travis-ci.org/derek-ooohtv/gitops-helm.svg?branch=master)](https://travis-ci.org/derek-ooohtv/gitops-helm)
...
![gitops](https://github.com/derek-ooohtv/openfaas-flux/blob/master/docs/screens/flux-helm-gitops.png)
...
You can fork the [gitops-helm](https://github.com/derek-ooohtv/gitops-helm) project and use it as a template for your cluster config.
...
--set git.url=git@github.com:derek-ooohtv/gitops-helm \
--namespace flux \
weaveworks/flux
```
...
I will be using [podinfo](https://github.com/derek-ooohtv/k8s-podinfo) to demonstrate a full CI/CD pipeline including promoting releases between environments.  
...
```
$ cd hack && ./ci-mock.sh -r dhilder/podinfo -b dev
...
....
Step 12/15 : COPY --from=builder /go/src/github.com/derek-ooohtv/k8s-podinfo/podinfo .
....
Step 15/15 : CMD ["./podinfo"]
....
Successfully built 71bee4549fb2
Successfully tagged dhilder/podinfo:dev-kb9lm91e
The push refers to repository [docker.io/dhilder/podinfo]
36ced78d2ca2: Pushed 
```
...
spec:
  ...
  chart:
    ...
    ref: master
  values:
    image: dhilder/podinfo:dev-kb9lm91e
    replicaCount: 1
```
...
![gitops-automation](https://github.com/derek-ooohtv/openfaas-flux/blob/master/docs/screens/flux-helm-image-update.png)
...
![gitops-chart-change](https://github.com/derek-ooohtv/openfaas-flux/blob/master/docs/screens/flux-helm-chart-update.png)
...
```bash
$ cd hack && ./ci-mock.sh -r dhilder/podinfo -b stg

Successfully tagged derek-ooohtv/podinfo:stg-9ij63o4c
The push refers to repository [docker.io/derek-ooohtv/podinfo]
8f21c3669055: Pushed 
```
...
spec:
  ...
  chart:
    ...
    ref: master
  values:
    image: dhilder/podinfo:stg-9ij63o4c
    replicaCount: 2
    hpa:
      enabled: true
      maxReplicas: 10
...
* make the CI tooling publish images from my hotfix branch to `dhilder/podinfo:hotfix-sha`
...
```bash
$ cd hack && ./ci-mock.sh -r dhilder/podinfo -v 0.4.10

Successfully built f176482168f8
Successfully tagged dhilder/podinfo:0.4.10
``` 
...
spec:
  ...
  chart:
    ...
    ref: master
  values:
    image: derek-ooohtv/podinfo:0.4.10
    replicaCount: 3
```
...
```bash
$ cd hack && ./ci-mock.sh -r dhilder/podinfo -v 0.4.11

Successfully tagged dhilder/podinfo:0.4.11
```

![gitops-semver](https://github.com/derek-ooohtv/openfaas-flux/blob/master/docs/screens/flux-helm-semver.png)
...
![SealedSecrets](https://github.com/derek-ooohtv/openfaas-flux/blob/master/docs/screens/flux-secrets.png)
